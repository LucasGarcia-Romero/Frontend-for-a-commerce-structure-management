...
function Login(){
    ...
    const handleLogin = async (e) => {
      ...
      try {
        ...
        const result = await fetch("/api/usuarios_registrados", {
          method: "POST",
        ...
        if (data.message === "OK") {
          ...
          //le paso a las opciones en nombre de usuario (luego tiene que trabajar con el)
          window.location.href = '/usuarios_registrados/opciones?usuario=' + username;
