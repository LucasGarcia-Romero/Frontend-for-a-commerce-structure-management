...
function App() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // **Cambio:** La configuración `body` de la función `fetch()` está vacía.
      const result = await fetch( 'api/administrador', {
        method: "POST",
      ...
      if (data.message === "OK") {
        ...
        window.location.href = "administrador/alta_de_comercios";
      } else {
...
// Exporta el componente principal de la aplicación (en este caso, App)
export default App;
/*
